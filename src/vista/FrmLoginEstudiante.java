...
public class FrmLoginEstudiante extends javax.swing.JDialog {

    /**
     * Creates new form FrmLogin
     */
    public FrmLoginEstudiante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void ingresar() {
        ...
        if (cedulaIngresada.equals("1150182051") && contraIngresada.equals("estudi12345")) {
            // Las credenciales son válidas, abre el formulario FrmUsuario
            FrmEva frmEva = new FrmEva(null, true); // Debes ajustar esto según tu implementación
